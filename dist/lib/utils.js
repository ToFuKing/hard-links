...
var forEachFiles = function (_params) {
    var folder = _params.folder, _a = _params.includesFolder, includesFolder = _a === void 0 ? [] : _a, _b = _params.excludes, excludes = _b === void 0 ? [] : _b, callback = _params.callback;
    ...
    var __readFiles = function (root) {
        ...
        (0, fs_1.readdirSync)(root).forEach(function (item) {
            ...
            if (stat.isDirectory()) {
                ...
                if (includesFolder.length > 0)
                    if (!includesFolder.some(function (i) { return fullPath.startsWith(i); }))
                        return;
